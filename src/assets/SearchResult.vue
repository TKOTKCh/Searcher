        ...
        >
          ...
          <el-row>
            ...
            <el-col :span="10" v-if="picture_text == 1" v-loading="loading" >
              <div style="margin-bottom: 25px;display: flex;overflow: hidden;
                    font-size: 15px;
...
export default {
  ...
  methods: {
    ...
    intoContent(item){
      axios
          .post(
              "http://123.249.41.125:8081/bm25/count?id=" +
              item.id
          )
    ...
    async search() {
      ...
      if(this.check){
        axios
            .get(
                "http://123.249.41.125:8081/user/addUserQuery?userid=" + this.user.id
      ...
      if(this.place!='全部'){
        await axios
            .get(
                "http://123.249.41.125:8081/bm25/search_condition?keyword=" +
    ...
    async getFirstPage() {
      ...
      await axios
          .get(
              "http://123.249.41.125:8081/bm25/search_condition",{
                params:{
    ...
    //   let outer = this;
    //   await axios
    //     .get("http://123.249.41.125:9090/related_word?word=" + outer.search_word)
    //     .then((response) => (outer.info = response.data));
    ...
    async querySearchAsync(queryString, cb) {
      ...
      if (queryString == '') {
        ...
        await axios
            .get("http://123.249.41.125:8081/bm25/completion?query=" + this.search_word)
            .then((response) => {
    ...
    async getHot(){
      ...
      await axios
          .get(
              "http://123.249.41.125:8081/bm25/hot"
          )
    ...
    async getHis(){
      if(this.check){
        ...
        await axios
            .get(
                "http://123.249.41.125:8081/user/getLastQuery?userid=" +this.user.id
            )
